          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form class="row" action="<?php echo base_url('user/to-cao/tim-kiem/') ?>"> 
                  <div class="col-sm-2">
                    <label>Người Bị Tố Cáo</label>
                    <input type="text" name="nguoibitocao" class="form-control" placeholder="Tài khoản người bị tố cáo" value="<?php echo $post['nguoibitocao'] ?>">
                  </div>
                  <div class="col-sm-2">
                  ...
                  <tbody>
                    <?php foreach ($list as $key => $value): ?>
                      <tr>
                        ...
                        <td><a href="<?php echo base_url('user/nguoi-dung/'.$this->Model_ToCao->getUserVictim($value['NanNhan'])[0]['MaNguoiDung'].'/xem/') ?>"><?php echo $this->Model_ToCao->getUserVictim($value['NanNhan'])[0]['TaiKhoan']; ?></a></td>
                        <td>
              ...
              <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                  <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                      <li class="page-item"><a class="page-link" href="<?php echo base_url('user/to-cao/tim-kiem/'.$i.'/trang/?nguoibitocao='.$post['nguoibitocao']) ?>"><?php echo $i; ?></a></li>
                    <?php } ?>      
                </ul>
              </div>
            </div>
