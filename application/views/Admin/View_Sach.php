                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                  	<?php foreach ($list as $key => $value): ?>
                        ...
                        <td>
                          <a href="<?php echo base_url('admin/chuyen-muc/'.$value['MaChuyenMuc'].'/sua/'); ?>"><?php echo $value['TenChuyenMuc']; ?></a>
                        </td>
                        <td>
                        ...
                        <td>
	                      ...
	                      <td>
	                      	<a href="<?php echo base_url('admin/sach/'.$value['MaSach'].'/sua/'); ?>" class="btn btn-primary" style="color: white;">
	                      	<i class="fas fa-edit"></i>
                            <span>SỬA</span>
                          </a>
                         	<a href="<?php echo base_url('admin/sach/'.$value['MaSach'].'/xoa/'); ?>" class="btn btn-danger" style="color: white;">
              ...
              <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                	<?php for($i = 1; $i <= $totalPages; $i++){ ?>
                  		<li class="page-item"><a class="page-link" href="<?php echo base_url('admin/sach/'.$i.'/trang/') ?>"><?php echo $i; ?></a></li>
                  	<?php } ?>      
                </ul>
              </div>
            </div>
